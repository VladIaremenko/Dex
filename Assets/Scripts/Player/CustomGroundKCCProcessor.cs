...
public partial class CustomGroundKCCProcessor : KCCProcessor, IGroundKCCProcessor
{
	// CONSTANTS
	...
	[field: SerializeField, Tooltip("Maximum allowed speed the KCC can move with player input.")]
	public float KinematicSpeed { get; set; } = 8.0f;
	...
	public override void SetKinematicSpeed(KCC kcc, KCCData data)
	{
		...
		else
		{
			...
			data.KinematicSpeed = Mathf.Lerp(0.0f, KinematicSpeed, 1.0f - slowdown);
		}
